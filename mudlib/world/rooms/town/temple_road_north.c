...
void create() {
    ...
    set_long(
        "The road continues northward, the cobblestones becoming even more pristine. " +
        "Religious symbols are carved into the stone walls of nearby buildings. " +
        "The peaceful atmosphere of the temple district envelops you."
    );
